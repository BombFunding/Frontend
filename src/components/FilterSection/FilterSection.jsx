...
function FilterSection() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="mt-36 mb-12 py-6 px-2 border-solid border-2 border-bomborange rounded-lg w-[80vw] text-[1vw] place-items-center place-self-center"
    >
      <div className={`flex flex-row rtl gap-3 ${styles.flexBox}`}>
        ...
        <Popover open={open1} onOpenChange={setOpen1}>
          <PopoverTrigger asChild>
            ...
            >
              {mainCategory
                ? categories.find((category) => category.value === mainCategory)
                    ?.label
                : "همه دسته‌بندی‌ها"}
                  ...
                  {categories.map((category) => (
                    <CommandItem
                      ...
                      onSelect={(currentValue) => {
                        setMainCategory(
                          currentValue === mainCategory ? "" : currentValue
                        );
                        setOpen1(false);
                      }}
        ...
        >
          ...
          <SelectContent className="rtl">
            <SelectItem value="most-recent" className="hover:cursor-pointer">
              جدیدترین
            </SelectItem>
            <SelectItem value="top-visited" className="hover:cursor-pointer">
              پربازدیدترین
            </SelectItem>
            <SelectItem value="top-liked" className="hover:cursor-pointer">
              محبوب‌ترین
            </SelectItem>
          </SelectContent>
        </Select>
      ...
      <div className="flex gap-2 place-self-end pt-5 pr-5">
        ...
        <Checkbox checked={favorite} onCheckedChange={setFavorite} />
      </div>
    </form>
  );
}
