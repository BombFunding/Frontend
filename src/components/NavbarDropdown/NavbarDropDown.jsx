	...
	return (
		<button
			...
			className={`flex items-center z-[-10] gap-1 font-vazirmatn h-full align-middle place-self-center rounded-lg px-3 py-1.5 text-sm transition-colors ${
				selected === tab
					? " bg-bomborange text-neutral-100"
					: "text-neutral-800"
			}`}
		>
			<span>{children}</span>
			...
			<div className="grid grid-cols-2 gap-2">
				<a href="#" className="">
					...
					<p className="text-xs text-neutral-400">
						تیم لایق و زحمتکش جلو-انتها که مداوم با تلاش های
						روزافزون در راستای تکمیل وظایف محول شده در اسپرینت به
						انجام آنها پرداختند
					</p>
				</a>
				<a href="#" className="">
					...
					<p className="text-xs text-neutral-400">
						تیم بک که شامل میلاد زارعی و ترانه عبداللهی می باشد به
						مقدار زیادی کار می کنند
					</p>
				</a>
			</div>
			<button className="ml-auto mt-4 flex items-center gap-1 text-sm text-indigo-300">
