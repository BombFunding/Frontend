            ...
            <Command className="border-solid border-2 border-gray-200 p-3">
              ...
              <CommandList>
                ...
                <CommandGroup heading="نتایج">
                  {(investments ? investments : mockData).map((item, index) => (
                    <CommandItem className="hover:cursor-pointer" key={index}>
                      <InvestotItem
                        username={item.username}
                        valueOfInvestment={item.investment_amount}
                        investTime={item.investment_date}
                        id={Math.random()}
                      />
                    </CommandItem>
                  ))}
