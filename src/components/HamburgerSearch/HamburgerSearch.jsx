...
const SearchSlider = ({ isVisible, onClose }) => {
	...
	return (
		<motion.div
			initial={{ marginTop: "120vh", visibility: "hidden" }}
			animate={{ marginTop: isVisible ? "0vh" : "120vh", visibility: "visible" }}
		...
		>
			<div className="flex flex-col h-full">
				...
				<div
					className={`${styles.searchbar} flex flex-col place-items-center`}
				>
					<SearchBar
