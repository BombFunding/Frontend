...
function Project({ className }) {
  ...
  return (
    ...
    <div
      ...
      className={`${className} w-[80vw] flex flex-col justify-start items-end`}
    >
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-3/5 flex flex-col gap-3">
          <img src={image} className={`w-full ${styles.image}`} />
      ...
      <div className="flex flex-col-reverse lg:flex-row">
        ...
        <div className="my-[2vw] flex place-items-center w-full justify-end">
          ...
          <div className="text-black text-2xl">:مجموع سرمایه جمع‌آوری شده</div>
        </div>
      </div>
      ...
      <div className="text-black w-[95%] place-self-center">{description}</div>
      <PageView />
      <CommentSection />
    </div>
  );
