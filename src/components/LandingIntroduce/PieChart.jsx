...
const get_revenue_data = async () => {
	try {
		const response = await fetch(`${baseURL}/landing/category-revenue/`, {
			method: "GET",
		});
		if (!response.ok) {
...
const get_count_data = async () => {
	try {
		const response = await fetch(`${baseURL}/landing/category-count/`, {
			method: "GET",
		});
		if (!response.ok) {
			throw new Error("Network response was not ok");
...
const get_liked_data = async () => {
	try {
		const response = await fetch(`${baseURL}/landing/category-liked/`, {
			method: "GET",
		});
		if (!response.ok) {
			throw new Error("Network response was not ok");
...
const get_viewd_data = async () => {
	try {
		const response = await fetch(`${baseURL}/landing/category-viewd/`, {
			method: "GET",
		});
		if (!response.ok) {
			throw new Error("Network response was not ok");
