      ...
      <div className="relative">
        ...
        <div className="p-8 flex flex-col gap-3 font-vazirmatn">
          ...
          <div className="flex flex-col justify-evenly mr-3 gap-1">
            ...
            <Label className=" text-xs">ایمیل: {profileInfo.email}</Label>
          ...
          <div className="flex justify-center items-center gap-6 ">
            {profileInfo.linkedinAccoun && (
              <a href={profileInfo.linkedinAccount}>{<LinkedInIcon />}</a>
            )}
            {profileInfo.telegramAccount && (
              <a href={`https://t.me/${profileInfo.telegramAccount}`}>
                {<TelegramIcon />}
              </a>
            )}
            {profileInfo.twitterAccount && (
              <a href={`https://x.com/${profileInfo.twitterAccount}`}>
                {<XIcon />}
              </a>
            )}
            {profileInfo.website && (
