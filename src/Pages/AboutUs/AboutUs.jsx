      ...
      return (
        <div className="ml-5">
          ...
          <section className="py-14 lg:py-24 relative z-0 bg-gray-50 w-full mx-auto">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center mx-auto w-full">
              ...
              ارتباط استارتاب ها و سرمایه گذاران با<span className="text-orange-600 font-vazirmatn"> بامب فاندینگ </span>
              </h1>
              <p className="max-w-sm mx-auto text-center text-base font-normal leading-7 text-gray-500 mb-9 font-vazirmatn">
                ...
                <br></br>
                و کمک به شروع استارتاپ های تازه</p>
            </div>
          </section>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative ">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-9">
                <div className="img-box">
                  <img src="https://pagedone.io/asset/uploads/1702034769.png" alt="About Us tailwind page" className="max-lg:mx-auto object-cover" />
                </div>
                <div className="lg:pl-[100px] flex items-center justify-cente">
                  <div className="data w-full">
                    <h2 className="font-manrope font-bold text-4xl lg:text-5xl text-black mb-9 max-lg:text-center relative font-vazirmatn"> درباره ما </h2>
                    <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto font-vazirmatn">
                    تیم بامب فاندینگ اینجاست تا ارتباطی قوی و موثر بین استارتاپ‌ها و سرمایه‌گذاران ایجاد کند. اگر سرمایه‌گذار هستید، می‌توانید با اطلاعات شفاف و اطمینان بیشتر، در آینده‌ای روشن سرمایه‌گذاری کنید. اگر استارتاپ هستید، اینجا فرصت‌های بی‌نظیری برای رشد و موفقیت کسب‌وکارتان در انتظار شماست. ما کنارتان هستیم تا مسیرتان به سوی پیشرفت هموارتر شود و رویاهایتان را به واقعیت تبدیل کنید
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative ">
              <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                <div className="lg:pr-24 flex items-center">
                  <div className="data w-full">
                    <img src="https://pagedone.io/asset/uploads/1702034785.png" alt="About Us tailwind page" className="block lg:hidden mb-9 mx-auto object-cover" />
                    <h2 className="font-manrope font-bold text-4xl lg:text-5xl text-black mb-9 max-lg:text-center font-vazirmatn">فعالیت ما از ۱۴۰۳ شروع شده</h2>
                    <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto font-vazirmatn">
                     تیم بامب فاندینگ پروژه خودش رو از سال ۱۴۰۳ در به عنوان در تحلیل و طراحی شون انجام داده و بخاطر پتانسیل بالاش، حالا تبدیل به یک سایت خیلی بزرگتر برای استفاده مردم سراسر ایران شده 
                    </p>
                  </div>
                </div>
                <div className="img-box ">
                  <img src="https://pagedone.io/asset/uploads/1702034785.png" alt="About Us tailwind page" className="hidden lg:block object-cover" />
                </div>
              </div>
            </div>
          </section>
          <section className="py-20 bg-white">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h2 className="font-manrope text-4xl text-center text-gray-900 font-bold mb-14 font-vazirmatn">نتیجه پروژه ما</h2>
                ...
                <div className="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-white p-6 rounded-2xl shadow-md shadow-gray-100">
                  <div className="flex gap-5">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl text-gray-900 font-semibold mb-2 font-vazirmatn">رشد سرمایه شرکت</h4>
                      <p className="text-xs text-gray-500 leading-5 font-vazirmatn">رشد قابل توجه شرکت ما در نتیجه زحمت های بسیار تیم بامب فاندینگ</p>
                    </div>
                  </div>
                </div>
                <div className="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-white p-6 rounded-2xl shadow-md shadow-gray-100">
                  <div className="flex gap-5">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl text-gray-900 font-semibold mb-2 font-vazirmatn">رشد تیم شرکت</h4>
                      <p className="text-xs text-gray-500 leading-5 font-vazirmatn">تیم بامب فاندینگ در کنار رشد شرکت، رشد می کنه تا بتونه بهترین تجربه کاربری رو به یوزر های عزیزمون بده </p>
                    </div>
                  </div>
                </div>
                <div className="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-white p-6 rounded-2xl shadow-md shadow-gray-100">
                  <div className="flex gap-5">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl text-gray-900 font-semibold mb-2">استارتاپ های موفق در سایت ما</h4>
                      <p className="text-xs text-gray-500 leading-5 font-vazirmatn">سایت بامب فاندینگ با افتخار تونسته به بیش از ۱۰ استارتاپ کمک کنه تا بتونند وارد بازار بشند و کسب درآمد کنند</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className=" py-14 lg:py-24 bg-gray-50">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
              <div className="mb-16 rounded-full">
                <h2 className="text-4xl font-manrope font-bold text-gray-900 text-center rtl font-vazirmatn">نظر های یوزر های راضی سایت ما !</h2>
              </div>
              <div style={{swiperNavigationColor: '#fff', swiperPaginationColor: '#fff'}} className="swiper mySwiper2">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="relative mb-20">
                      ...
                      <div className="flex justify-center w-full mx-auto lg:max-w-4xl">
                        ...
                        از زمانی که پروژه‌ام رو در این سایت معرفی کردم، واقعاً تحولی در روند جذب سرمایه‌گذار به وجود اومد. طراحی و ساختار سایت خیلی ساده و کاربرپسنده. تونستم با استفاده از ابزارهای جستجوی دقیق و فیلترهای کاربردی، سرمایه‌گذارهایی رو پیدا کنم که دقیقاً با نیازهای استارتاپ من همخوانی داشتند. این سایت علاوه بر اینکه دسترسی به سرمایه‌گذاران رو برای ما راحت کرده، به ما این امکان رو می‌ده که ایده‌ها و پروژه‌هایمون رو به طور حرفه‌ای و جذاب معرفی کنیم. قطعاً این سایت یکی از بهترین تصمیمات ما بود و توصیه می‌کنم هر استارتاپی که به دنبال رشد و توسعه است، از این پلتفرم استفاده کنه.                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="relative mb-20">
                      ...
                      <div className="max-w-max mx-auto lg:max-w-4xl">
                        ...
                        به عنوان یک سرمایه‌گذار که به دنبال پروژه‌های نوآورانه هستم، این سایت به من کمک کرد که خیلی سریع به استارتاپ‌های جدید و پرپتانسیل دسترسی پیدا کنم. دسته‌بندی دقیق استارتاپ‌ها، اطلاعات شفاف و راحتی در ارتباط با تیم‌ها، از ویژگی‌های برجسته این پلتفرم است. من می‌تونم به راحتی استارتاپ‌هایی که با اهداف من همخوانی دارند رو پیدا کنم و در صورت نیاز، جلسات مشاوره و سرمایه‌گذاری ترتیب بدم. این سایت واقعاً یک ابزار قدرتمند برای کسانیه که می‌خوان به دنبال فرصت‌های جدید سرمایه‌گذاری برن.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="relative mb-20">
                      ...
                      <div className="max-w-max mx-auto lg:max-w-4xl">
                        <p className="text-lg text-gray-500 leading-8 mb-8 text-center rtl font-vazirmatn">
                        استارتاپ من همیشه در جستجوی راه‌هایی برای معرفی ایده‌ها و جذب سرمایه‌گذاران جدید بوده. با استفاده از این پلتفرم، تونستیم نه تنها سرمایه‌گذاران جدیدی پیدا کنیم، بلکه بازخوردهای بسیار مفیدی از اون‌ها دریافت کنیم که باعث شد روند توسعه استارتاپمون رو سریع‌تر پیش ببریم. سیستم‌های دسته‌بندی و نمایش داده‌های سایت به‌قدری خوب طراحی شده که برای تیم‌های استارتاپی مثل ما، پیدا کردن اطلاعات و برقراری ارتباط با سرمایه‌گذاران ساده‌تر می‌شه. این سایت برای هر استارتاپی که می‌خواد پیشرفت کنه، یک ابزار ضروریه.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {/* <div thumbsslider className="swiper mySwiper">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <img src="https://pagedone.io/asset/uploads/1704349534.png" alt="Emily image" className="mx-auto scale-90 transition-all duration-300 swiper-slide:w-16 border rounded-full swiper-slide:border-indigo-600 object-cover" />
                  </div>
                  <div className="swiper-slide">
                    <img src="https://pagedone.io/asset/uploads/1704349572.png" alt="Ethan image" className="mx-auto scale-90 transition-all duration-300 swiper-slide:w-16 border rounded-full swiper-slide:border-indigo-600 object-cover" />
                  </div>
                  <div className="swiper-slide">
                    <img src="https://pagedone.io/asset/uploads/1704349514.png" alt="Olivia image" className="mx-auto scale-90 transition-all duration-300 swiper-slide:w-16 border rounded-full swiper-slide:border-indigo-600 object-cover" />
                  </div>
                </div>
              </div> */}
            </div>
          ...
          <section className="flex py-14 lg:py-24 ">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mb-24">
                <h2 className="font-manrope text-4xl text-center font-bold text-gray-900 mb-6 font-vazirmatn">با رهبران ما آشنا بشید
                </h2>
              </div>
              {/*Slider Wrapper*/}
              <div className="swiper teamswiper pb-10">
                <div className="swiper-wrapper items-center">
                  <div className="swiper-slide">
                    <div className="group w-full flex-wrap flex items-center gap-8  transition-all duration-500 p-8  lg:flex-nowrap ml-20">
                      <div className=" w-full lg:w-48 h-64">
                        <img src="https://pagedone.io/asset/uploads/1696238786.png" alt="image" className="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full" />
                      </div>
                      <div className="text-center lg:text-left lg:max-w-xs flex-1 font-vazirmatn">
                        <div className="mb-5 pb-5 border-b border-solid border-gray-300">
                          <h6 className="text-lg text-gray-900 font-semibold mb-1">ایلان ماسک</h6>
                          <span className="text-sm text-gray-500 group-hover:text-orange-600">شریک و مالک</span>
                        </div>
                        <p className="text-gray-500 leading-6 mb-7">
                            من مالک بامب فاندینگ هستم و ما مرز هامون رو شکستیم تا شرکت رو موفق کنیم
                        </p>
                        <div className="flex items-center gap-4 justify-center lg:justify-start">
                          <p className="cursor-pointer  text-gray-900 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-orange-600">
                  ...
                  <div className="swiper-slide">
                    <div className="group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap ml-20">
                      <div className=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                        <img src="https://pagedone.io/asset/uploads/1696238869.png" alt="image" className="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full" />
                      </div>
                      <div className="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between font-vazirmatn">
                        <div className="mb-5 pb-5 border-b border-solid border-gray-300">
                          <h6 className="text-lg text-gray-900 font-semibold mb-1">زن قبلی ایلان ماسک</h6>
                          <span className="text-sm text-gray-500 group-hover:text-orange-600">رهبر دیزاین</span>
                        </div>
                        <p className="text-gray-500 leading-6 mb-7">
                          از روز اول تاسیس شرکت رهبر دیزاین بودم و از هر لحظه اش لذت بردم
                        </p>
