    ...
    const updateData = async (bodyData) => {
      ...
      await postData("/auth/update_baseuser_profile/", bodyData)
        .then((res) => {
          ...
          setFullname(res.profile.first_name + " " + res.profile.last_name);
      ...
      reader.onloadend = () => {
        ...
        postImageData("/auth/update_baseuser_profile/", formData)
          .then((res) => {
            ...
            setHeader(`http://104.168.46.4:8000${res.profile.header_picture}`);
            toast.dismiss(toastId);
            toast.success(<CustomToast Header="بنر با موفقیت بارگزاری شد" />);
          })
          .catch((err) => {
